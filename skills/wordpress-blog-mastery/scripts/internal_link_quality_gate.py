...
if __name__ == '__main__':
    ...
    ap.add_argument('--word-count', type=int, default=0)
    a = ap.parse_args()

    t = open(a.html_path, encoding='utf-8', errors='ignore').read()
    ...
    print(json.dumps({
        ...
        'generic_anchor_violations': generic,
        'anchor_length_3_8_words_count': len_ok,
        'density_rule_pass': density_ok,
        'minimum_links_pass': min_links_ok,
        'pass': (len(generic) == 0 and density_ok and min_links_ok)
    }, indent=2))
