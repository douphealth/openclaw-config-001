...
3. **Detail** — Add workflow steps, rules, and anti-patterns
4. **Route** — Add "Do NOT Use For" cross-references to adjacent skills
5. **Test** — Validate trigger accuracy against real prompt examples
6. **Audit** — Score using `quality-scorecard` before publishing
