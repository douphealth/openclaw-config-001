...
STATE = Path('/home/openclaw/.openclaw/workspace/state/master_orchestrator_mode.json')

def nowz():
    return datetime.datetime.now(datetime.timezone.utc).isoformat().replace('+00:00','Z')

if __name__ == '__main__':
    ap = argparse.ArgumentParser(description='pause/resume/status for master orchestrator')
